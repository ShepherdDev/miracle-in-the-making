<%@ control language="c#" inherits="ArenaWeb.Templates.MITM_RightPanel" CodeFile="~/Templates/MITM_RightPanel.ascx.cs" %>
	...
	<div id="content">
	  ...
	  <div id="contentTop">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td valign="top" width="640"><div id="mainpane"><asp:PlaceHolder runat="server" ID="MainPane" /></div></td>
                            <td valign="top"><div id="rightpane"><asp:PlaceHolder runat="server" ID="RightPane" /></div></td>
                          </tr>
                        </table>
